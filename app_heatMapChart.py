...
data = [[item[1], item[0], item[2] if item[2] != 0 else "-"] for item in data]
...
app.layout = dmc.MantineProvider(
    ...
    children=[
        ...
        dcc.Store(id="x-axis-store", data=x_axis),  # Store x-axis
        dcc.Store(id="y-axis-store", data=y_axis),  # Store y-axis
        dcc.Store(id="data-store", data=data),  # Store data
    ],
)

clientside_callback(
    ClientsideFunction(namespace="eCharts_heatMapChart", function_name="Chart"),
